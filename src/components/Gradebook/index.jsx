...
Gradebook.propTypes = {
  ...
  assignmentTypes: PropTypes.arrayOf(PropTypes.shape({
    id: PropTypes.string,
  })),
  ...
  grades: PropTypes.arrayOf(PropTypes.shape({
    section_breakdown: PropTypes.arrayOf(PropTypes.shape({
      ...
      is_graded: PropTypes.bool.isRequired,
      label: PropTypes.string.isRequired,
      module_id: PropTypes.string.isRequired,
      percent: PropTypes.number.isRequired,
      scoreEarned: PropTypes.number.isRequired,
      scorePossible: PropTypes.number.isRequired,
      subsection_name: PropTypes.string.isRequired,
    })),
